...
@Component({
  ...
  template: `
    ...
    >
      <h4 class="text-primary/70 ml-1 mb-4 mt-48">
        Hi👋I'm Nate, from Ethiopia.
      </h4>
      <h1
        class="text-8xl text-primary header leading-[90px] tracking-tighter"
      >
        I'm a frontend web developer <br />
        with expertise in
        <span class="px-2 bg-surface-50 header mt-1 rounded-md pt-2"
          >Angular 18.</span
        >
      </h1>
